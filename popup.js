...
const courseHTML = function (obj) {
  return `<div class="space-y-[17px]"> 
                ...
                <div class="px-[20px] space-y-[12px]">
                  <button class="btn-md btn-primary-primary btn-icon-right w-full justify-center flex js-add-to-cart">
...
const cards = document.querySelectorAll(".Hovercourse");
let counter = document.querySelector(".js-counter")
let count = 0
let added_cart = []
for (let i = 0; i < cards.length; i++) {
  cards[i].addEventListener("mouseenter", function () {
    const obj = arr_courses[i];
    const popup = this.querySelector(".js_popup");

    popup.innerHTML = courseHTML(obj);

    popup.querySelector(".js-add-to-cart").addEventListener("click", function () {
      count += 1
